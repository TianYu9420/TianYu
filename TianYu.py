    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                ...
                cl.sendMessage(op.param1, "感謝您加入我為好友 定名可以順便給呦".format(str(cl.getContact(op.param1).displayName)))
        if op.type == 11:
        ...
        if op.type == 13:
            ...
            if clMID in op.param3:
                ...
                if settings["autoJoin"] == True:
                    ...
                    ban["owners"][op.param2] =ban["owners"][op.param2] -1
                    cl.acceptGroupInvitation(op.param1)
                    cl.sendMessage(op.param1, "你還擁有{}張票".format(str(ban["owners"][op.param2])))
                    if ban["owners"][op.param2] == 0:
                        del ban["owners"][op.param2]
                else:
                    cl.acceptGroupInvitation(op.param1)
                    cl.sendMessage(op.param1,"You do not have any ticket.")
