...
admin =['u787d6464e208dad899bdc1f80eaf9284',clMID]
owners = ["u787d6464e208dad899bdc1f80eaf9284"]
        ...
        if op.type == 13:
            ...
            if clMID in op.param3:
                ...
                if gInviMids == []:
                    ...
                    cl.sendMessage(op.param1,"被幹者黑單中...")
        if op.type == 17:
            if op.param2 in admin or op.param2 in ban["bots"]:
                return
...
#==============================================================================#
            if sender in K0 or sender in owners:
                if text.lower() == 'help':
                    ...
                    cl.sendContact(to,"u787d6464e208dad899bdc1f80eaf9284")
                elif text.lower() == 'bye':
...
#==============================================================================#
                    ...
                    for target in targets:
                        try:
                            cl.sendMessage(to,"免費ANA全日空來回機票一張ww 感謝您的搭乘")
                            cl.kickoutFromGroup(msg.to,[target])
                        ...
                        for mention in mentionees:
                            if clMID in mention["M"]:
                                if settings["detectMention"] == True:
                                    ...
                                    cl.sendMessage(to, "怎麼了? 如果有急事 請私我")
                                break
            try:
                msg = op.message
